// stage content:
(lib.TeacherClassReportUsage = function(appObj) {
	this.initialize();
    ...
    contentImage.src = "./img/"+this.appObj.lang_i18n+"_TeacherClassReportUsage.png";
    this.contentImage = new createjs.Bitmap(contentImage);
    this.contentImage.setTransform(0,0);  
    
    var menuImage = new Image();
    menuImage.src = "./img/"+this.appObj.lang_i18n+"_TeacherClassReportUsage_Menu.png";
    ...
    this.classReports.graphics.beginFill("#000").drawRect(0,0,150,60);
    this.classReports.x=520;
    this.classReports.y=265;
    
    // dashboard  rectangle
    this.dashboardRectangle=new createjs.Shape();
    this.dashboardRectangle.alpha = 0.01;
    if (this.appObj.lang_i18n == 'ar')
        this.dashboardRectangle.graphics.beginFill("#000").drawRect(0,0,210,40);
    else            
        this.dashboardRectangle.graphics.beginFill("#000").drawRect(0,0,135,40);
    this.dashboardRectangle.x=230;
    this.dashboardRectangle.y=130;
    ...
    switch(this.myState)
    {
        ...
        case BUILD_INTERFACE:
            ...
            this.classReports.onClick = function() {
               self.appObj.launchModule('TeacherStudentReport');
               
            }
            
            this.addChild(this.dashboardRectangle);
            this.dashboardRectangle.onClick = function() {
