// stage content:
(lib.TeacherOverview = function(appObj) {
	this.initialize();
    ...
    this.classReports.graphics.beginFill("#000").drawRect(0,0,190,170);
    this.classReports.x=487;
    this.classReports.y=400;
